...
이전 이름의 설치본(`RhwpMac.app`, `AlhangeulMac.app`, `알한글.app`)은 LaunchServices/PlugInKit discovery 충돌의 원인이 될 수 있다. 다만 충돌이 확인되거나 의심될 때만 작업지시자 승인 후 제거한다. 무조건적인 사전 제거는 다른 사용자 설치본을 지울 위험이 있다.
