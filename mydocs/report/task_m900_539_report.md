...
v0.2.2(20)의 버전·문구·검증 계획을 준비했다. #536/#538 이 반영된 devel d3376fc 기준이며 직전 공개는 v0.2.0(18), core/Studio는 v0.8.6이다. **v0.2.2(20)을 2026-09-14 22:18:49 KST에 공개했다. 양 VM·실제 Mac 사전 수용과 실제 0.2.0 → 0.2.2 Sparkle 다운로드·설치·자동 재실행·기존/새 문서 검색·Finder가 통과했다. 2026-09-15 업데이트 후 Spotlight GUI의 영문·한글 검색과 결과 열기도 통과했다.**
...
#513 / #337 / #535 / #532 / #520 / #539 는 최종 GUI까지 수용하여 종료 조건을 충족했으며, 기록 PR 병합 뒤 Stage 5의 근거별로 완료 처리한다. #532 는 실패한 v0.2.1 공개 성공이 아닌 v0.2.2 대체로 종료한다. macOS 12 미검증·#525·Homebrew 범위는 기존과 같다. 이전 후보의 실패·부분 수용을 새 후보 성공으로 바꾸지 않는다.

최종 문서 보정은 공개·자동 업데이트 기록 PR #547 에 이어서 제출한다. README·검색 안내를 실제 0.2.2 보완과 정렬했고, 이전 후보 보고서에는 현재 종료 판단과 당시 실패 기록의 경계를 표시했다.
