...
v0.2.2(20)의 버전·문구·검증 계획을 준비했다. #536/#538 이 반영된 devel d3376fc 기준이며 직전 공개는 v0.2.0(18), core/Studio는 v0.8.6이다. **서명 draft DMG·양 VM 재시험과 실제 Mac 저장 종료/Finder/명령 검색은 PASS다. Spotlight GUI 검색·결과 열기도 확인했으며, 공개·실제 Sparkle 업데이트가 남아 있다.**
...
실제 Mac은 시스템 색인을 작업지시자가 활성화한 기존 환경이며, 재설치 실행 전부터 검색됐으므로 결과는 검색 유지다. Stage 4.2의 GUI 수용을 마쳤으며, 최종 공개 승인 → 동일 DMG 공개 → public hash·Pages/appcast·실제 0.2.0 → 0.2.2 Sparkle 순서가 남아 있다.
