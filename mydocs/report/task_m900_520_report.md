...
v0.2.0 공개 이후 남긴 동일 버전 재설치 요청 기록 조건을 #530 에서 보완하고 #539 의 v0.2.2에서 수용했다. #513 / #337 의 종료 조건도 충족했다. v0.2.0 최초 실패·대조·재시험 기록은 그대로 보존한다. [v0.2.2 공개·실제 Sparkle/GUI 수용](../working/task_m900_539_stage5.md)에 최종 근거를 연결하며 기록 PR 병합 뒤 이슈를 정리한다. 아래 미실행·OPEN 표시는 당시 단계의 기록이다.
