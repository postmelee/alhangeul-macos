...
- milestone/label 기준은 현재 GitHub 설정에 의존한다. milestone 설명이나 label 체계가 바뀌면 `task-register` 본문을 갱신해야 한다.
...
Stage 4 커밋은 본 보고서, Stage 4 보고서, 오늘할일 완료 처리를 포함한다.
