...
[Stage 4](../working/task_m020_338_stage4.md)에서 UTI 목록의 진실 원천과 후속 자동 대조 스크립트를 명시했다. HostApp의 9개 UTI와 설계 목록을 다시 대조했고 제품 소스 변경은 없다. PR milestone·label은 v0.2 설계 작업 분류로 정렬한다.
