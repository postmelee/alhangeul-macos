...
[Stage 4](../working/task_m020_339_stage4.md)에서 루트 깊이 0·64 초과와 문서 전체 순회 중단을 명시했다. 공개 field 샘플 도움말 제외 보완은 PR #509의 20개 Rust 회귀에 포함된다. 기존 prefix 계약과 구현을 유지하며 이 문서 PR에서 제품 코드는 바꾸지 않았다.
