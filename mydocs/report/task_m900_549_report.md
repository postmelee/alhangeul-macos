...
README/Pages/Release와 릴리즈 기록의 이전 Homebrew 0.1.11 안내를 바로잡았다. 공개 Release 본문은 이미 반영·재조회했으며 Pages 문구는 main PR 병합 후 배포된다. [Stage 3](../working/task_m900_549_stage3.md)의 로컬 검사와 기존 public appcast byte 보존 검사는 PASS다. runbook의 모든 경로별 수용 근거와 예외는 [v0.2.2 기록](../release/v0.2.2.md)에 모았다.
