...
기존 `/Users/melee/Applications/RhwpMac.app`는 단일 설치본 검증을 위해 `/Users/melee/Applications/RhwpMac.app.stage27-smoke-disabled`로 옮겨 둔 상태다.

`알한글.app` 단일 설치 기준을 유지하려면 삭제하고, 이전 설치본 비교가 필요하면 별도 조사 전까지 보존한다.
