...
#536/#542/#543 구현·84개 회귀와 양 VM schema 3 수용, 실제 동일 DMG 공개 승격을 완료했다. 검증 도구의 종료 조건을 충족했다. [v0.2.2 공개·실제 Sparkle/GUI 수용](../working/task_m900_539_stage5.md)에 최종 근거를 연결하며 기록 PR 병합 뒤 이슈를 정리한다. 아래 미실행·OPEN 표시는 당시 단계의 기록이다.
