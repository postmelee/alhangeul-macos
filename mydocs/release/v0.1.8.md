...
2026-07-19 Stage 3에서 candidate `2872cd1492cb2a72101f9e9a9bedfd620748d4eb` 기준 source preflight와 별도 승인된 local rehearsal을 완료했다. rehearsal DMG는 159,624,609 bytes이고 checksum과 `hdiutil verify`, mounted layout 검증을 통과했지만 unsigned 검증 산출물이므로 public GitHub Release, Sparkle 또는 Homebrew에 사용하지 않는다.
