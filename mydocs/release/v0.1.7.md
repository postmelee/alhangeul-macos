...
| 항목 | 값 |
|------|----|
| 상태 | `v0.1.7` build `13` public release 완료 |
| 목표 Git tag | `v0.1.7` |
...
| Homebrew Cask | repository Cask는 `v0.1.6`, v0.1.7 미반영 |
| Release 실행 이슈 | [#378](https://github.com/postmelee/alhangeul-macos/issues/378) |

이 문서는 `rhwp v0.7.17` 반영과 `v0.1.7` public release의 source metadata, release communication, 검증 결과를 기록한다. 2026-07-19 live 조회에서 GitHub Release는 non-draft/non-prerelease public 상태이고, public DMG asset digest는 위 SHA256과 일치했다. 아래 Stage 3/4 절은 당시 gate 준비 기록이며 최종 공개 상태는 이 상단 표와 다음 완료 보정을 우선한다.

## Public release 완료 보정

| 항목 | 확인 결과 |
|------|-----------|
| GitHub Release | `Alhangeul v0.1.7 (rhwp v0.7.17)` |
| 공개 시각 | `2026-06-24T21:37:20Z` |
| release 상태 | non-draft, non-prerelease |
| Public DMG | `alhangeul-macos-0.1.7.dmg`, 156,747,415 bytes |
| Public DMG SHA256 | `332208ff6f68c78a49d0fc60b895eeabb41d4996dad38fde158fa1935ab4b09d` |
| SHA256 asset | `alhangeul-macos-0.1.7.dmg.sha256` |
| Homebrew source | repository Cask `v0.1.6`, v0.1.7 미반영 |

이 보정은 공개 GitHub Release와 repository Cask의 현재 상태를 반영한다. 당시 local rehearsal 결과와 pre-public gate 준비 절은 수정하지 않는다.
