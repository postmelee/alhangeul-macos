...
|------|------|----------------|-------------------|-----------|
| `v0.1.11` | 공개 보류 — signed draft HWP3 변환 저장 실패, 수정 승인 대기 | [검증 실패 draft](https://github.com/postmelee/alhangeul-macos/releases/tag/untagged-9fe71ba4d0e2e4372b1b) | [로컬 문서 후보](../../docs/updates/v0.1.11.html) | [`v0.1.11.md`](v0.1.11.md) |
