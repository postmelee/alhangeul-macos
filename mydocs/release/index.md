...
|------|------|----------------|-------------------|-----------|
| `v0.1.11` | 공개 준비 — Stage 2 문서 후보, 앱·배포 검증 대기 | [게시 예정](https://github.com/postmelee/alhangeul-macos/releases/tag/v0.1.11) | [로컬 문서 후보](../../docs/updates/v0.1.11.html) | [`v0.1.11.md`](v0.1.11.md) |
