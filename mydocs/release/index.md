...
|------|------|----------------|-------------------|-----------|
| `v0.1.11` | 공개 준비 — Stage 3 source/package 결과·예외 기록, signed 검증 대기 | [게시 예정](https://github.com/postmelee/alhangeul-macos/releases/tag/v0.1.11) | [로컬 문서 후보](../../docs/updates/v0.1.11.html) | [`v0.1.11.md`](v0.1.11.md) |
