...
```bash
rg -n "앱 release identity|릴리즈 식별자|Release metadata|rhwp v0.7.10|edwardkim/rhwp/releases/tag/v0.7.10|Alhangeul v0.1.1|bundled rhwp|rhwp-studio|release handoff|upstream sync|자동 upstream sync" \
...
git diff --check -- README.md docs/updates/v0.1.1.html mydocs/release/v0.1.1.md mydocs/manual/release_policy_guide.md mydocs/manual/release_github_pages_sparkle_guide.md
```
