...
- [x] `xcodegen generate`
- [x] `xcodebuild -project AlhangeulMac.xcodeproj -scheme HostApp -configuration Debug -derivedDataPath build/DerivedData CODE_SIGNING_ALLOWED=NO build`
- [x] `git diff --check`

## 문서

- 수행 계획서: `mydocs/plans/task_m050_22.md`
- 구현 계획서: `mydocs/plans/task_m050_22_impl.md`
- 최종 보고서: `mydocs/report/task_m050_22_report.md`
