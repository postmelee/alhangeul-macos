...
| `Release Publish DMG` | `workflow_dispatch` | `contents: write`, `environment: release` | macOS | tag 검증, signed/notarized universal DMG, GitHub Release asset, stable Sparkle appcast, release delta checklist artifact 생성 |
