...
2026-09-14 재개: Stage 4.1은 draft 파일·양 VM·실제 Mac에서 완료한 문서/Finder/명령 검색 증거를 기록한다. Spotlight GUI는 창 접근 후 별도로 판정하며, 미완료 항목을 PASS로 합산하지 않는다. 읽기 전용 승격 검증과 실제 공개를 구분한다.
