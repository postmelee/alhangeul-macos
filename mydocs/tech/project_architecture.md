...
- HostApp PDF export, Quick Look preview, Finder thumbnail, 장기 Swift native viewer/editor 전환 경로가 이 계층을 공유한다. HostApp MVP viewer 화면은 WKWebView `rhwp-studio` 경로를 사용한다.
