...
- 현재 lock은 Demo/Preview commit pin 상태다. 2026-04-27 확인 release `v0.7.6`에도 `RustBridge`가 사용하는 `build_page_render_tree`, `get_bin_data` API가 없어 Stable 전환은 blocked 상태다.
