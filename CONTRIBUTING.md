...
상세한 Git 흐름은 [`git_workflow_guide.md`](mydocs/manual/git_workflow_guide.md)를, 브랜치 역할 판단은 [`branch_strategy_webview_native.md`](mydocs/tech/branch_strategy_webview_native.md)를 참고하세요.
...
기여하신 코드와 문서는 본 저장소의 [MIT License](LICENSE)에 따라 배포됩니다.

별도 서면 합의가 없는 한 기여자는 자신이 작성한 기여물의 저작권을 보유합니다. Pull request, patch, 문서, asset을 제출할 때는 해당 기여물을 제출하고 본 저장소의 MIT License로 배포할 권리가 있음을 전제로 합니다.
