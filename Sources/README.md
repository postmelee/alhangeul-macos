...
| `Shared/` | 첫 페이지 bitmap 렌더링 등 HostApp/extension 공통 macOS helper | `HostApp`, `QLExtension`, `ThumbnailExtension` |
...
- AppKit drawing과 SwiftUI viewer 상태는 `Sources/HostApp`이 소유한다.
