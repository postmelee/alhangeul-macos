...
<h3>Mac에서 한글 파일은 더 이상 이방인이 아닙니다.</h3>
...
<strong>알한글(alhangeul-macos)</strong>은 Mac에서 HWP/HWPX 파일을 Finder, Quick Look, Spotlight, PDF 변환까지 다루는 오픈소스 문서 유틸리티입니다.
> Rust 기반 [`rhwp`](https://github.com/edwardkim/rhwp) 코어를 macOS 앱, Quick Look preview, Finder thumbnail, Swift bridge로 연결합니다.
