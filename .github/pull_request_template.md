...
- 단계 보고서: [task_m{milestone}_{issue}_stage1.md](https://github.com/postmelee/alhangeul-macos/blob/{head_sha}/mydocs/working/task_m{milestone}_{issue}_stage1.md)
