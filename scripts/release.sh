...
sign_sparkle_for_notarization() {
  ...
  # Re-seal the app after changing nested framework signatures. Preserve the
  # expanded entitlements generated by Xcode so Sparkle sandbox exceptions stay.
  codesign_developer_id "$APP_OUTPUT"
}
